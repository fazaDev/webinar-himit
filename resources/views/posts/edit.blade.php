                ...
                <form method="POST" action="{{route('post.update', $post->id)}}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input id="input-title" name="title" class="form-control" value="{{ $post->title }}" placeholder="Title..." type="text">
                    ...
                    <div class="pl-lg-4">
                        <div class="form-group">
                            ...
                            <textarea rows="4" name="content" class="form-control">{{ $post->content }}</textarea>
